...
export default function TestApp() {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("h1", { children: "Insert company identifier!" }), _jsxs("div", { children: [_jsx("input", { type: 'text', placeholder: 'Company slug or ID', onChange: (e) => {
                        ...
                        } }), _jsx("button", { onClick: () => setInitialised(true), children: "Test integration" })] }), _jsx("div", { style: { marginTop: 20 }, children: companyIdentifier && initialised && (_jsxs(_Fragment, { children: [_jsx("div", { children: _jsx("button", { onClick: () => sendDineoutEvent('testIntegration', {
                                    'local': true,
                                    'date': new Date().toISOString(),
                                }), children: "Send Integration Test Event" }) }), _jsx(DineoutTracking, { companyIdentifier: companyIdentifier })] })) })] }));
}
;
