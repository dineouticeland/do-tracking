export type { Platform, TrackingConfig, BaseTrackEvent, SinnaBookingEvent, SinnaBookingEventMap, DineoutReservationEvent, DineoutReservationEventMap, TrackableEvent, TrackableEventMap, EventMapping, TrackMethod, EventMap, TrackingEventFunction, } from './types.js';
